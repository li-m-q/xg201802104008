...
//    DELETE, http://localhost:8080/department.ctl?id=1, 删除id=1的系
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //读取参数id
        String id_str = request.getParameter("id");
        String para = request.getParameter("paraType");
    ...
    //响应一个系对象
    private void responseDepartmentBySchool(int schoolId, HttpServletResponse response)
            throws ServletException, IOException, SQLException {
        //根据id查找学院
        Collection<Department> department = DepartmentService.getInstance().findAllBySchool(schoolId);
        String department_json = JSON.toJSONString(department);
