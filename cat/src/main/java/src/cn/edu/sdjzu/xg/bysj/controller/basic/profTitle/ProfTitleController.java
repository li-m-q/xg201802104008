package src.cn.edu.sdjzu.xg.bysj.controller.basic.profTitle;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializerFeature;
import src.cn.edu.sdjzu.xg.bysj.domain.ProfTitle;
import src.cn.edu.sdjzu.xg.bysj.service.ProfTitleService;
...
public class ProfTitleController extends HttpServlet {
    ...
    /**
     * POST, http://localhost:8080/school.ctl, 增加职称
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ProfTitle profTitleToAdd;
        profTitleToAdd = JSON.parseObject(proftitle_json, ProfTitle.class);
